...
{
    /// <inheritdoc />
    public partial class PawchiveInitialSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dowloadVideoWorks = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    dowloadImageWorks = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    dowloadEmbed = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    fetchedTime = table.Column<DateTime>(type: "datetime", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExternalWorks", x => new { x.id, x.type });
                    table.ForeignKey(
