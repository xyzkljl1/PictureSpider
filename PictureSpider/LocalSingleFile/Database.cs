 ...
 * 数据库迁移：
   ...
   Add-Migration -Context PictureSpider.LocalSingleFile.Database -Args "A ConnStr=server=127.0.0.1;port=4321;UID=root;pwd=pixivAss;database=localsinglefile;" <版本名>
   //执行迁移文件
   Update-Database -Context PictureSpider.LocalSingleFile.Database -Args "A ConnStr=server=127.0.0.1;port=4321;UID=root;pwd=pixivAss;database=localsinglefile;"
 */
